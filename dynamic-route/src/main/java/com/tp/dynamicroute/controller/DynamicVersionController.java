package com.tp.dynamicroute.controller;
...
public class DynamicVersionController {
    ...
    public Long getLastVersion(){
        Long versionId = 0L;
        String result = redisTemplate.opsForValue().get(RedisConfig.VERSION_KEY);
        if(!StringUtils.isEmpty(result)){
            ...
            redisTemplate.opsForValue().set(RedisConfig.VERSION_KEY , String.valueOf(versionId));
        }
        return versionId;
    }
